...
function DeleteTeacher({ selectedTeacher}: { selectedTeacher: TeacherRowData | null}) {


    const { data, error, execute,isLoading } = useFetch<TeacherResponse>({
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Delete {selectedTeacher?.email}?</DialogTitle>
