...
function EditStudent({ selectedStudent}: { selectedStudent: StudentRowData | null}) {
    ...
    const [role, setRole] = useState<string | undefined>(selectedStudent!.role)
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Edit {selectedStudent?.email}?</DialogTitle>
