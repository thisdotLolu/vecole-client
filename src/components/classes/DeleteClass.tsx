...
function DeleteClass({ selectedClass}: { selectedClass: ClassRowData | null}) {


    const { data, error, execute,isLoading } = useFetch<ClassResponse>({
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Delete {selectedClass?.name}?</DialogTitle>
